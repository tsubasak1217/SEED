...
impl ColliderShapeData {
    ...
    pub fn to_physics_shape(&self) -> ColliderShape {
        match self {
            Self::Box { half_extents } => ColliderShape::Box {
            ...
            Self::ConvexHull { vertices } => ColliderShape::ConvexHull {
                vertices: vertices.clone(),
            },
            Self::TriangleMesh { triangles } => ColliderShape::TriangleMesh {
